...
namespace ScottEuser\FractalTwigcs\Rule;
...
/**
 * Class FractalUnusedVariable.
 *
 * The only change here is adding `case 'render':` to line 57.
 *
 * @package unu\Rule
 */
class FractalUnusedVariable extends UnusedVariable
{
    /**
     * {@inheritdoc}
     */
